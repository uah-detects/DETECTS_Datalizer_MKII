...
var prettyHeader= ["Time","Last Time","Lat","Lng","Speed","Course","Altitude (m)","Temperature (Celcius )","Pressure (Pa)","Ascent Rate (M/Sec)","Distance Traveled (M)","Absolute Value Course"];
